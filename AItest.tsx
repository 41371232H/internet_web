        ...
        {page === 'chat' && (
          ...
          >
            <div style={styles.header}>
              <button onClick={() => setPage('home')} style={styles.backBtn}>← 返回</button>
              <h2>健康飲食小助手</h2>
            </div>
...
const styles: Record<string, React.CSSProperties> = {
  wrap: {
    ...
    alignItems: 'flex-start', // 🔹 靠上顯示
    background: 'linear-gradient(135deg, #86efac, #22c55e)',
    fontFamily: '"Noto Sans TC", sans-serif',
    paddingTop: 10, // 🔹 留上方空間
    paddingBottom: 80, // 🔹 避免底部被遮住
  },
  home: {
    color: '#fff',
    textAlign: 'center',
  ...
  composer: { display: 'grid', gridTemplateColumns: '1fr auto', gap: 8, padding: 16, borderTop: '1px solid #e5e7eb' },
  textInput: { padding: '10px 12px', borderRadius: 10, border: '1px solid #e5e7eb' },
  sendBtn: { background: '#10b981', color: '#fff', border: 'none', borderRadius: 999, padding: '10px 18px', cursor: 'pointer' },
  examples: { display: 'flex', flexWrap: 'wrap', gap: 8, padding: '12px 16px 20px', borderTop: '1px solid #e5e7eb' },
  suggestion: {
    padding: '6px 10px',
    borderRadius: 999,
